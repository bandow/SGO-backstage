;(function($){
    ...
    $('body').append('<style>'+
                ...
                '.sel-box .btn1{overflow:hidden;width:22px;height:22px;float:left;margin:11px 12px;}'+
                ...
                '       <div class="btn">'+
                '           <div class="btn1 ok"><img src="images/submit.png" alt="确定"></div>'+
                '           <div class="btn1 cancel"><img src="images/close.png" alt="取消"></div>'+
